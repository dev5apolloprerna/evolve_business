            ...
            <div class="container-fluid">
                ...
                {{-- This is search field start --}}
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="post" id="form" action="{{ route('members.index') }}">
                                    @csrf
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <div class="d-flex align-items-center w-100">
                                                <select class="form-select select2 w-100" id="category_id" name="category_id" onchange="updatesubcategories()" data-choices name="name">
                                                    <option class="w-100" value="">Select Category</option>
                                                    @foreach ($category as $categori)
                                                        <option value="{{ $categori->id }}" {{ isset($categorysearch) && $categori->id == $categorysearch ? 'selected' : '' }}>
                                                            {{ $categori->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                    ...
                                                    <div class="modal fade" id="changepassword" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <form method="post" action="{{ route('members.changepassword') }}" autocomplete="off">
                                                                    @csrf
                                                                    @method('post')
