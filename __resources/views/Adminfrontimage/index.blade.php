@extends('layouts.app')
@section('title', 'Banner Image List')
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <div class="card-header">
                                <h5 class="card-title mb-0">Add Banner Image </h5>
                            </div>
                            <div class="card-body">
                                <div class="live-preview">
                                    <form action="{{ route('Adminfrontimage.store') }}" method="post"
                                    enctype="multipart/form-data">
                                        ...
                                        <div class="row gy-4" style="align-items: end;">
                                            <div class="col-lg-12">
                                                ...
                                                <div>
                                                    <span style="color:red;">*</span>Button link
                                                    <input type="text" class="form-control" name="button_link" id="button_link"
                                                         placeholder="Enter Button Link" maxlength="100"
                                                        autocomplete="off" required>   
                                                </div>
                                                <!-- <div>
                                                    <span style="color:red;">*</span>Title
                     ...
                     <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Banner Image List</h5>
                            </div>
                            <div class="card-body">
                                <?php //echo date('ymd');
                                ?>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($datas as $data)
                                            <tr>
                                                ...
                                                <td><img src="{{ asset('Adminfrontimage') . '/' . $data->photo }}"
                                                                            style="width: 40px;height: 40px;">
                                                </td>
                                                <td class="text-center">{{ $data->button_link }}</td>
                                                  <td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" onsubmit="return EditvalidateFile()"
                                action="{{ route('Adminfrontimage.update') }}" autocomplete="off"
                                enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" onblur="editchkname();" name="name"
                                            id="Editname" placeholder="Enter Title" maxlength="100" autocomplete="off"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <span style="color:red;">*</span>Photo</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="button_link"
                                            id="Editbutton_link" placeholder="Enter Button link" maxlength="100" autocomplete="off"
                                            required>
                                    </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                    ...
                                    <form id="user-delete-form" method="POST"
                                        action="{{ route('Adminfrontimage.delete') }}">
                                        @csrf
                                        @method('DELETE')
...
@section('scripts')
    ...
    <script>
        function getEditData(id) {
            //alert(id);
            var url = "{{ route('Adminfrontimage.edit', ':id') }}";
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#Editbutton_link").val(obj.button_link);
                        $('#getid').val(id);
                        $('#hiddenPhoto').val(obj.photo);
                        var html = "";
                        if (obj.photo) {
                            html = '<img src="/Adminfrontimage/' + obj.photo +
