                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header" style="display: flex;justify-content: space-between;">
                            ...
                            <a class="btn btn-success" href="{{ route('Usermember.blogcreate') }}">Add
                                Blog</a>
                        </div>
                        <div class="card-body">
                                                            ...
                                                            <thead class="bg-200 text-900">
                                                                <tr>
                                                                    ...
                                                                    <th width="5%"  data-sort="Title">Blog
                                                                        Title</th>
                                                                    <th width="5%"  data-sort="Photo">Blog
                                                                        Image</th>

                                                                    <th width="5%" data-sort="Title">
                                                                        Status</th>
                                                                    {{-- @foreach ($Data as $data)
                                                                        @if ($data->role_id == 2)
                                                                            <th width="5%" 
                                                                                data-sort="Title">rejectedcomments</th>
                                                                        @endif
                                                                    @endforeach --}}
                                                                    @if ($user->role_id == 2)
                                                                        <th width="5%" data-sort="Title">
                                                            ...
                                                            <tbody class="list">
                                                                ...
                                                                @foreach ($Data as $data)
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td>
                                                                            @if(isset($data->rejectedcomments))
                                                                            {{ $data->rejectedcomments }}
                                                                            @else
                                                                              N/A 
                                                                            @endif  
                                                                        ...
                                                                        <td>
                                                                            <a href="{{ route('Usermember.blogedit', $data->blogsid) }}"
                                                                                class="" title="Edit">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12  col-xs-12 col-sm-12 padding-5 bottom-border-verydark">
                                                                <div class="alert alert-info clearfix profile-information padding-all-10 margin-all-0 backgroundgreen">
                                                                    <h1 class="font-white text-center">Yet To Add Blog </h1>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form id="user-delete-form" method="POST" action="{{ route('Usermember.delete') }}">
                            @csrf
                            @method('DELETE')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('Usermember.status') }}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            @if (isset($data->blogstatus))
                                <!-- <select class="form-control" name="newStatus">
                                            <option value="1" {{ $data->blogstatus == 1 ? 'selected' : '' }}>Approved
                                            </option>
                                            <option value="0" {{ $data->blogstatus == 0 ? 'selected' : '' }}>Rejected</option>
                                        </select> -->
                                ...
                                <select class="form-control" name="newStatus" id="newStatus"
                                    ...
                                    <option value="2" {{ $data->blogstatus == 2 ? 'selected' : '' }}>Rejected
                                    </option>
                                </select>
                            @else
                                <select class="form-control" name="newStatus">
                        ...
                        @foreach ($Data as $item)
                            <div class="form-group rejectedComments"
                                style="display: {{ $item->blogstatus == 2 ? 'block' : 'none' }}">
...
@section('scripts')
    ...
    <script>
        var editor = CKEDITOR.replace('editdesc', {
            language: 'en',
            extraPlugins: 'notification'
        });
