                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs nav-justified nav-border-top nav-border-top-success mb-3" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="{{ route('MemberBusiness.index') }}">
                                        <i class="ri-home-5-line align-middle me-1"></i> Pending
                                    </a>
                                </li>

                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="{{ route('MemberBusiness.approve_list1') }}" role="tab"
                                        aria-selected="false" tabindex="-1">
                                        <i class="ri-user-line me-1 align-middle"></i> Approved
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="{{ route('MemberBusiness.rejected_list1') }}" role="tab"
                                        aria-selected="false" tabindex="-1">
