                ...
                <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="pt-2">
                                                    ...
                                                    <input type="text" class="form-control" name="name" id="name"
                                                        onblur="chkname();" placeholder="Enter Sub Category Name"
					...
					<tr>
					    <td class="text-center">{{ $i + $datas->perPage() * ($datas->currentPage() - 1) }}</td>
                                         <td class="text-center">{{ optional($category->firstWhere('id', $data->category_id))->name }}</td>
					    <td class="text-center">{{ $data->name }}</td>
					    <td>
						<div class="d-flex gap-2">
						    <a class="mx-1" title="Edit" href="#" data-id="{{ $data->id }}" data-bs-toggle="modal"
							data-bs-target="#showModal" onclick="getEditData(this)">
							<i class="far fa-edit"></i>
						    </a>

						    <a class="" href="#" data-bs-toggle="modal" title="Delete" data-bs-target="#deleteRecordModal"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" onsubmit="return EditvalidateFile()"
                                action="{{ route('subcategories.update') }}" autocomplete="off"
                                enctype="multipart/form-data">
                                @csrf
                                ...
                                <div>
                                    ...
                                    <select class="form-control" name="category_id" id="category_id" required>
                                        ...
                                        @foreach ($category as $city)
                                        <option value="{{ $city->id }}" {{ $city->id == $data->category_id ? 'selected' : '' }}>
                                        {{ $city->name }}
                                        </option>
                                    @endforeach
                                    ...
                                    <div class="mb-3 pt-3">
                                        ...
                                        <input type="text" class="form-control" onblur="editchkname();" name="name"
                                            id="Editname" maxlength="100" autocomplete="off" 
                                            required>
                                    </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                    ...
                                    <form id="user-delete-form" method="POST"
                                        action="{{ route('subcategories.delete') }}">
                                        @csrf
                                        @method('DELETE')
...
@section('scripts')
    ...
    function getEditData(element) {
        ...
        var url = "{{ route('subcategories.edit', ':id') }}";
    ...
    <script>
        function editchkname() {
            ...
            var id = $('#getid').val();
            var url = "{{ route('subcategories.editcheckserviceprovider') }}";
            ...
            $.ajax({
                ...
                success: function(data) {
                    console.log(data);
                    if (data == 1) {
                        alert('Sub Categories Name Already Exists');
                        $('#Editname').val('');
                        $('#Editname').focus();
                        return false;
                    }
