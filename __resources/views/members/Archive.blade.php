        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" id="form" action="{{ route('members.Archive') }}">
                                @csrf
                                    ...
                                    <div class="col-md-3 mb-2">
                                        <div class="d-flex align-items-center w-100">
                                            <select class="form-select select2 w-100" id="category_id" name="category_id"
                                                onchange="updatesubcategories()" data-choices name="name">
                                                <option class="w-100" value="">Select Category</option>
                                                @foreach ($category as $categori)
                                                    <option value="{{ $categori->id }}"
                                                        {{ isset($categorysearch) && $categori->id == $categorysearch ? 'selected' : '' }}>
                                                        {{ $categori->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <a href="{{ route('members.Arrival_member', ['user_id' => $data->id]) }}"
