...
@section('content')
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h5 class="card-title mb-0" data-anchor="data-anchor">Member Of The Week
                                    </h5>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <table class="table table-bordered table-striped fs--1 mb-0">
                                                <thead class="bg-200 text-900">
                                                    <tr>
                                                        ...
                                                        <th scop="col">Book Member of the week start Date</th>
                                                        <th scop="col">Book Member of the week End Date</th> 
                                                        <th scop="col">Available time</th>
                                                    ...
                                                    @foreach ($datas as $datas1)
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <td class="text-center">                                                             
                                                               ...
                                                               {{ \Carbon\Carbon::parse($datas1->Member_of_the_week_enddate)->format('d-m-Y') }}
                                                           </td>  
                                                           <td class="text-center">{{$datas1->Book_week_time}}</td>                                                          
                                                            <td>   
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form id="user-delete-form" method="POST" action="{{ route('Memberrequest.delete_week') }}">
                            @csrf
                            @method('DELETE')
    ...
    <div class="modal fade" id="statusModal" tabindex="-1" role="dialog" aria-labelledby="statusModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="statusModalLabel">Book Your Member of the week
                        </h5>
                ...
                <div class="modal-body">
                    <form action="{{route('Memberrequest.addstatus')}}" method="post">
                        @csrf
                        <input type="hidden" name="id" value="" id="member_id">
                        <input type="hidden" name="user_id" value="" id="user_id">
                        <div class="form-group">
                            <label for="Book_Your_Member_of_the_week">Book Your Member of the week:</label>
                            <input type="text" name="Book_Your_Member_of_the_week" class="form-control" id="Book_Your_Member_of_the_week">
                        </div>
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var obj = JSON.parse(data);
                        $('#member_id').val(id);
                        $("#Book_Your_Member_of_the_week").val(obj.Book_Your_Member_of_the_week);
...
<script>
    $(function() {
        $("#Book_Your_Member_of_the_week").datepicker({
            dateFormat: "yy-mm-dd",
            //minDate: 0
        });      
    });
