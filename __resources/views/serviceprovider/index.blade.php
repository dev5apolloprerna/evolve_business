                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    <form action="{{ route('serviceprovider.store') }}" method="post"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" onsubmit="return EditvalidateFile()"
                                action="{{ route('serviceprovider.update') }}" autocomplete="off"
                                enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" onblur="editchkname();" name="city_name"
                                            id="Editname" maxlength="100" autocomplete="off" value={{$datas['city_name']}}
                                            >
                                    </div>
...
@section('scripts')
    ...
    <script>
        function getEditData(id) {
            //alert(id);
            var url = "{{ route('serviceprovider.edit', ':id') }}";
    ...
    <script>
        function chkname() {
            ...
            var url = "{{ route('serviceprovider.checkserviceprovider') }}";
            $.ajax({
                url: url,
                type: 'GET',
                data: {
    ...
    <script>
        function editchkname() {
            ...
            var url = "{{ route('serviceprovider.editcheckserviceprovider') }}";
            $.ajax({
                url: url,
                type: 'GET',
                data: {
