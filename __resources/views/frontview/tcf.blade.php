                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 h-100 p-0">
								<div class="inner-column p-5">
                                    ...
                                    <div class="text-black mb-3 text-start">
                                        <p>
                                            GrOath has organised an open networking event for Business Enthusiasts of Ahmedabad , called The Cluster Fest. It is the 3rd edition.
 </p><p>
The event is to involve everyone in networking in the new way - The Cluster way. Yes , GrOath is well known for its Cluster Meet format.
 </p><p>
...
At Ahmedabad, Double Tree by Hilton
 ...
 <p class="mb-2">
GrOath Network ideated a networking concept called <span class="text-black mt-3">The Cluster Meet</span>. This format hosts <span class="text-black mt-3">only 5 to 7 entrepreneurs</span> meeting with quality time and complete focus for business networking.  We got tremendous response from <span class="text-black mt-3">Premier Business Enthusiasts of Ahmedabad</span> and they <span class="text-black mt-3">joined as member</span> of GrOath community to network in Cluster Meet format.
 </p><p class="mb-2">
To endorse the same success, GrOath has organised <span class="text-black mt-3">the third edition</span> of The Cluster Fest , called <span class="text-black mt-3">TCF 3.0</span> and invites <span class="text-black mt-3">ONLY 80 focused</span> business entrepreneur to network in same way, the Cluster Way.</p>
                                ...
                                <!--    <li>Why – Cluster meetings (Only fewer members meetings) is the essence of GrOath Network and Ahmedabad entrepreneurs welcomed this networking ideology. We got huge success and appreciation from our members.  </li>-->
