                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="serial_no" id="serial_no"
                                            ...
                                            onblur="serialnovalidate();" placeholder="Enter Serial No" maxlength="100"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="dealer_code"
                                            placeholder="Enter Dealer Code" maxlength="100" autocomplete="off" required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="location"
                                            placeholder="Enter Location" maxlength="100" autocomplete="off" required>
                                    </div>
