...
jQuery(document).ready(function ($) {
  ...
  TOptions = {
    ...
    header_section: function (self, animate_speed) {
      ...
      self.navigation
        .find(self.indicator_mobile)
        .on("click", function (subMenu) {
          // sub menu
    ...
    internal_scroll_links: function (self, scroll_speed) {
      ...
      self.navigation
        .find("a[href^='#']")
        .on("click", function (event, target, $target) {
          // Stop default behaviour
          event.preventDefault();
    ...
    team_section: function (self, galleryTop, galleryThumbs) {
      ...
      galleryTop = self.selector_team.swiper({
        // This is main selector. Which is used to initialize the plugin with options.
      ...
      galleryThumbs = self.team_thumbs.swiper({
        // This is main selector. Which is used to initialize the plugin with options.
    ...
    google_map: function (map, marker) {
      ...
      map = new google.maps.Map(this.selector_google_map, {
        center: { lat: 44.54, lng: -78.546 }, // Center map
      ...
      marker = new google.maps.Marker({
        position: { lat: 44.54, lng: -78.546 }, // Center map
