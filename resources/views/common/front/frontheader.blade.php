            ...
            <div class="col-xs-12 ls">
                ...
                <div class="site-logo">
                    ...
                    <a href="{{route('FrontIndex')}}">
                        <!-- Logo Image -->
                        <img width="150" src="{{ asset ('front/images/img/logo.png')}}" alt="Logo">
                    </a>
                </div>
                <!-- End logo -->
                ...
                <nav class="site-nav">
                    <ul>
                            ...
                            <li class="nav-item  @if (request()->routeIs('FrontAbout')) {{ 'active' }} @endif">
                                <a class="nav-link menu-link"
                                    href="{{route('FrontAbout')}}">
                                    <span data-key="t-dashboards">About Us</span>
                                </a>
                            </li>
                            <li class="nav-item  @if (request()->routeIs('Frontdicoverus')) {{ 'active' }} @endif">
                                <a class="nav-link menu-link"
                                    href="{{route('Frontdicoverus')}}">
                                    <span data-key="t-dashboards">Our Services</span>
                                </a>
                            </li>
                       <li class="nav-item  @if (request()->routeIs('Frontlearning')) {{ 'active' }} @endif">
                                <a class="nav-link menu-link"
                                    href="{{route('Frontlearning')}}">
                                    <span data-key="t-dashboards">L & D</span>
                                </a>
                            </li>
                           <li class="nav-item  @if (request()->routeIs('Frontnews')) {{ 'active' }} @endif">
                                <a class="nav-link menu-link"
                                    href="{{route('Frontnews')}}">
                                    <span data-key="t-dashboards">Events</span>
                                </a>
                            </li>
                      
                        <li><a href="#">PR
                            <i class="indicator-desktop fa fa-angle-down"></i> </a>
                        <i class="indicator-mobile fa fa-angle-down"></i>
                       
                        <!-- Sub menu level 1 -->
                        <ul class="sub-menu">
                             <li class="nav-item  @if (request()->routeIs('Frontphoto-album')) {{ 'active' }} @endif">
                                <a class="nav-link menu-link"
                                    href="{{route('Frontphoto-album')}}">
                                    <span data-key="t-dashboards">Photo Gallery</span>
                                </a>
                            </li>                        
                            <li class="nav-item  @if (request()->routeIs('Frontvideo-gallery')) {{ 'active' }} @endif">
                                <a class="nav-link menu-link"
                                    href="{{route('Frontvideo-gallery')}}">
                    ...
                    <li class="nav-item  @if (request()->routeIs('Frontblog')) {{ 'active' }} @endif">
                        <a class="nav-link menu-link"
                            href="{{route('Frontblog')}}">
                            <span data-key="t-dashboards">Blog</span>
                        </a>
                    </li>
                    <li class="nav-item  @if (request()->routeIs('Frontcontact-us')) {{ 'active' }} @endif">
                        <a class="nav-link menu-link"
                            href="{{route('Frontcontact-us')}}">
                            <span data-key="t-dashboards">contact us</span>
                        </a>
                    </li>  
                    
                     <li class="nav-item @if (request()->routeIs('Frontfront-login')) {{ 'active' }} @endif">
                        <a class="nav-link menu-link bsc-none"
                            href="{{route('Frontfront-login')}}">
                            <span data-key="t-dashboards">Login</span>
                        </a>
                    </li> 
                    
                        <li class="tb-scr-none">
                            <a class="button" href="{{route('Frontfront-login')}}">
