...
$file = file_get_contents($root . '/evolve_business_live/mailers/statusemail.html');
...
$gu_id = $data['gu_id'] ?? '';
$statusUpdateLink = url('https://evolv.co.in/evolv_business/newstatus/' . $gu_id);
$approveLink = url('https://evolv.co.in/evolv_business/approve/' . $gu_id);
$rejectLink = url('https://evolv.co.in/evolv_business/reject/' . $gu_id);
