                    ...
                    {{-- <div class="col-lg-4">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Add Points Name</h5>
                            </div>
                            <div class="card-body">
                                    ...
                                    <form action="{{ route('Points.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row gy-4" style="align-items: end;">
                                            <div class="col-lg-12">
                                                ...
                                                <div>
                                                    <span style="color:red;">*</span> Points Name
                                                    <input type="text" class="form-control" name="points_name"
                                                        id="points_name" placeholder="Enter Points Name" maxlength="100"
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="d-flex align-items-center gap-1">
                                                    <button type="submit"
                                                        class="btn btn-success btn-user float-right">Submit</button>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($datas as $data)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $data->points_name }}</td>
                ...
                <div class="modal fade flip" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" onsubmit="return EditvalidateFile()" action="{{ route('Points.update') }}"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="points_name" id="edit_points_name"
                                            maxlength="100" autocomplete="off" readonly value={{ $datas['points_name'] }}>
                                    </div>

                                    <div class="mb-3">
                                        <span style="color:red;">*</span>Point
                                        <input type="text" class="form-control" name="points" id="edit_points"
                                            maxlength="100" autocomplete="off" value={{ $datas['points'] }}>
                                    </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                    ...
                                    <form id="user-delete-form" method="POST"
                                        action="{{ route('serviceprovider.delete') }}">
                                        @csrf
                                        @method('DELETE')
