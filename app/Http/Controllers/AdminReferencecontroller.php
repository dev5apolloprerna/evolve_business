...
class AdminReferencecontroller extends Controller
{
    public function index(Request $request)
    {
        ...
        $Business = Reference::select(
            ...
            ->when($request->given_by, function ($query) use ($givenby) {
                $query->where('Reference.Reference_from', 'LIKE', '%' . $givenby . '%');
            })
        ...
        // ->toSql();
        // dd($Business);
        return view('Admin-Reference.index', compact('givenby', 'businesses', 'Business', 'Data', 'Datadrop', 'FromDate', 'ToDate', 'Count'));
    }
    ...
    public function approvelist(Request $request)
    {
        ...
        // ->toSql();
        // dd($Business);
        return view('Admin-Reference.Approve_list', compact('givenby', 'businesses', 'Business', 'Data', 'Datadrop', 'FromDate', 'ToDate', 'Count'));
    }
    ...
    public function rejected(Request $request)
    {
        ...
        // ->toSql();
        //   dd($Business);
        return view('Admin-Reference.Rejected_list', compact('givenby', 'businesses', 'Business', 'Data', 'Datadrop', 'FromDate', 'ToDate', 'Count'));
    }
