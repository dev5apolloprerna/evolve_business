                                                    ...
                                                    @foreach($members as $member)
                                                        <div class="col-12 col-md-6 col-lg-4">
                                                            <div class="card">
                                                                ...
                                                                <img class="cmp-lg" src="https://evolv.co.in/evolve_business/assets/images/users/user1.png" alt="No image" class="company-logo">
                                                                @else 
                                                                ...
                                                                <img class="cmp-lg" src="https://evolv.co.in/evolve_business/assets/images/users/undraw_profile.webp" alt="No image" class="company-logo">
                                                                @else 
