            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <!-- Button -->
                        <a href="https://evolv.co.in//{{ $item->button_link }}" class="theme-btn color-btn">Contact us</a>
                    </div>
                </div>
            </div>
            <!-- End bootstrap -->
            ...
            <div class="row align-items-center">
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                    <div class="inner-column sm-mt-43">
                        ...
                        <div class="text">Welcome to "Evolv", the premier platform for fostering meaningful
                            connections and
                            catalyzing professional growth. At Evolv, we believe that success thrives in the
                            fertile ground of
                ...
                <div class="col-xs-12">
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <!-- Button -->
                                <a href="https://evolv.co.in//news-detail/experience-meeting" class="theme-btn"> 
                                <!-- Icon -->  
                                Inquiry Now </a>
                            </div>
                        </div>
