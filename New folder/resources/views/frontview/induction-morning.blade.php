            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 no-padding">
                    <div class="pad-tb-50">
                        ...
                        <div class="bg-white3">
                            <!-- H1 heading -->
                            <h1 class="frm-hds text-center">evolve_business Cluster Meet </h1>
                            <!--<h6 class="frm-hds text-center">(19-04-2025)</h6>-->
                            <h3 class="frm-hds text-center">Visitor registration</h3>
                            <form action="{{ route('inductionstore') }}" method="post" enctype="multipart/form-data">
                                @csrf
    ...
    @endforeach
                                ...
                                <div class="frm-inp">
                                    <input type="text" placeholder="Reference name" id="reference_name"
                                        name="reference_name" maxlength="50" value="{{ old('reference_name_') }}">
                                </div>

                              
                                <div class="payment-container">
                                    <!--<p>Visitor fee : ₹ 600 + (18% tax)= 708 </p>-->
                                     <input type="hidden" placeholder="amount_fee" id="amount_fee" name="amount_fee"
                                        value="0" required>
                                    <!-- <p>For payment scan QR </p> -->
                                    <div class="text-center">
                                        <!-- <img width="150" src="{{ asset('/front/images/evolve_businessqr.jpg') }}" alt="QR Code for Payment"> -->
                                    </div>
                                </div>
