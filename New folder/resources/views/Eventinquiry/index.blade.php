...
@extends('layouts.app')
@section('title', 'Event Inquiry List')
@section('content')
                        ...
                        <div class="card-header">
                            <div class="row flex-between-end">
                                <div class="col-auto align-self-center">
                                    <h5 class="card-title mb-0" data-anchor="data-anchor">Event Inquiry List - {{ $eventname->name  }}
                                    </h5>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <table class="table table-bordered table-striped fs--1 mb-0">
                                                <thead class="bg-200 text-900">
                                                    <tr>
                                                        ...
                                                        <!-- <th width="2%" data-sort="Title">Event Name</th> -->
                                                        <th width="2%" data-sort="Title">Name</th>
                                                        <th width="5%" data-sort="Date">Email</th>
                                                        <th width="2%" data-sort="Title">Phone Number</th>
                                                        <th width="2%" data-sort="Title">company Name</th>
                                                        <th width="2%" data-sort="Title">Business Category</th>
                                                        <th width="2%" data-sort="Title">Referred By</th>
                                                        <th width="2%" data-sort="Title">Reference Name</th>
                                                        <th width="2%" data-sort="Title">ispaid</th>
                                                        <th width="2%" data-sort="Title">Payment Status</th>
                                                ...
                                                <tbody class="list">
                                                    ...
                                                    @foreach ($inquiry as $inquiry1)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">{{ $inquiry1->member_news_comment_name }}</td>
                                                            <td class="text-center">{{ $inquiry1->email }}</td>
                                                            <td class="text-center">{{ $inquiry1->phonenumber }}</td>
                                                            <td class="text-center">{{ $inquiry1->companyname }}</td>
                                                            <td class="text-center">{{ $inquiry1->businesscategory }}</td>
                                                             <td class="text-center">{{ $inquiry1->referred_by ?? 'N/A'}}</td>
                                                              <td class="text-center">{{ $inquiry1->reference_name ?? 'N/A' }}</td>
                                                               <td class="text-center">{{ $inquiry1->ispaid == '1' ? 'Yes' : 'No' }}</td>
                                                              <td class="text-center">
                                                                    @if ($inquiry1->Payment_Status == 0 && $inquiry1->ispaid == '1')
                                                                        <span style="color: blue;">Pending</span>
                                                                    @elseif($inquiry1->Payment_Status == 1 && $inquiry1->ispaid == '1')
                                                                        <span style="color: green;">Success</span>
                                                                    @elseif($inquiry1->Payment_Status == 3 && $inquiry1->ispaid == '1')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form id="user-delete-form" method="POST" action="{{ route('Eventinquiry.delete') }}">
                            @csrf
                            @method('DELETE')
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var html = "";
                        if (obj.photo) {
                            html = '<img src="/evolve_business/event/' + obj.photo +
