                                ...
                                <div class="card-header">
                                    <div class="row flex-between-end">
                                        <div class="col-auto align-self-center">
                                            <h5 class="card-title mb-0">Add Offer Banner</h5>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                                            ...
                                            <form onsubmit="return validateFile()" method="POST" id="myForm"
                                                action="{{ route('Banner.create') }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="mb-3">
                                                    <span style="color:red;">*</span>Title</label>
                                                    <input class="form-control" id="basic-form-name" name="Title" type="text"
                        ...
                        <div class="col-md-8 mt-3">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <div class="row flex-between-end">
                                        <div class="col-auto align-self-center">
                                            <h5 class="card-title mb-0" data-anchor="data-anchor">Offer Banner List
                                                </h5>
                                            </div>
                                        </div>
                                </div>
                                                    ...
                                                    <table class="table table-bordered table-striped fs--1 mb-0">
                                                        <thead class="bg-200 text-900">
                                                            <tr>
                                                                ...
                                                                <th width="5%" data-sort="Photo">Photo</th>
                                                                <th width="5%" data-sort="Photo">Action</th>
                                                               
                                                            </tr>
                                                        </thead>
                                                       <tbody class="list">
                                                            <?php $i = 1; ?>
                                                            @foreach ($Banner as $teem)
                                                                <tr>
                                                                    <td class="title"> {{ $i + $Banner->perPage() * ($Banner->currentPage() - 1) }}</td>
                                                                    <td class="title">{{ $teem->Title }}</td>
                                                                    <td><img src="{{ asset('Banner') . '/' . $teem->photo }}"
                                                                            style="width: 50px;height: 50px;">
                                                                    </td>
                                                                  
                                                                    <td class="d-flex gap-2 justify-content-center">
                                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#EditModal"
                                                                            onclick="getEditData(<?= $teem->banner_id ?>)"
                                                                            class="" title="Edit">
                                                                        ...
                                                                        <a class="" href="#" data-bs-toggle="modal"
                                                                            ...
                                                                            onclick="deleteData(<?= $teem->banner_id ?>);">
            ...
            <!--Delete Modal Start -->
                ...
                <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog " style="background-color: white;">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Edit Offer Banner</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </button>
                                </div>
                                <form onsubmit="return EditvalidateFile()" method="post"
                                action="{{ route('Banner.update') }}" enctype="multipart/form-data">
                                @csrf
                                @method('post')
                                    <div class="modal-body">

                                        <input type="hidden" name="banner_id" id="Overteem" value="">
                                        
                                        <div class="row">
                                            <div class="form-group">
                                                <span style="color:red;">*</span>Name</label>
                                                <input class="form-control" id="Editname" name="Title" type="text"
                                                    placeholder="Enter Title" value="{{ old('Title') }}" required>
                                                </div>
                                                <br>
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#Editname").val(obj.Title);
                        $('#hiddenPhoto').val(obj.photo);
                        $('#Overteem').val(obj.banner_id);
                        var html = "";
                        if (obj.photo) {
                            html = '<img src="/Banner/' + obj.photo +
