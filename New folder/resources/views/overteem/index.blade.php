    ...
    <div class="main-content">
                                ...
                                <div class="card-header">
                                    <div class="row flex-between-end">
                                        <div class="col-auto align-self-center">
                                            <h5 class="card-title mb-0">Add Our Team</h5>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                                            ...
                                            <form onsubmit="return validateFile()" method="POST" id="myForm"
                                                action="{{ route('overteem.create') }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="basic-form-designation" name="designation" type="text"
                        ...
                        <div class="col-md-8 mt-3">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <div class="row flex-between-end">
                                        <div class="col-auto align-self-center">
                                            <h5 class="card-title mb-0" data-anchor="data-anchor">Our Team List
                                                </h5>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div id="tableExample" data-list='{"valueNames":["name","email","age"]}'>
                                                <div class="table-responsive scrollbar">
                                                    ...
                                                    <table class="table table-bordered table-striped fs--1 mb-0">
                                                        ...
                                                        <tbody class="list">
                                                            <?php $i = 1; ?>
                                                            @foreach ($Overteem as $teem)
                                                                <tr>
                                                                    <td class="title"> {{ $i + $Overteem->perPage() * ($Overteem->currentPage() - 1) }}</td>
                                                                    <td class="title">{{ $teem->Overteem_name }}</td>
                                                                    <td><img src="{{ asset('overteem') . '/' . $teem->Overteem_photo }}"
                                                                            style="width: 50px;height: 50px;">
                                                                    </td>
                                                                    <td class="title">{{ $teem->designation }}</td>
                                                                    <td class="d-flex gap-2 justify-content-center">
                                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#EditModal"
                                                                            onclick="getEditData(<?= $teem->Overteem_id ?>)"
                                                                            class="" title="Edit">
                                                                        ...
                                                                        <a class="" href="#" data-bs-toggle="modal"
                                                                            ...
                                                                            onclick="deleteData(<?= $teem->Overteem_id ?>);">
                    ...
                    <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog " style="background-color: white;">
                            <div class="modal-content">
                                ...
                                action="{{ route('overteem.update') }}" enctype="multipart/form-data">
                                @csrf
                                @method('post')
                                    <div class="modal-body">

                                        <input type="hidden" name="Overteem_id" id="Overteem" value="">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <span style="color:red;">*</span>Designation</label>
                                                    <input class="form-control" id="EditDesignation" name="designation" type="text"
                                                        placeholder="Enter Designation" value="{{ old('designation') }}" required>
                                                </div>
                                                <div class="form-group">
                                                    <span style="color:red;">*</span>Description</label>
       ...
       <script>
           function getEditData(id) {
               //alert(id);
               var url = "{{ route('overteem.edit', ':id') }}";
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#Editname").val(obj.Overteem_name);
                        $("#EditDesignation").val(obj.designation);
                        $("#EditDescription").val(obj.description);
                        $('#hiddenPhoto').val(obj.Overteem_photo);
                        $('#Overteem').val(obj.Overteem_id);
                        var html = "";
                        if (obj.Overteem_photo) {
                            html = '<img src="/overteem/' + obj.Overteem_photo +
