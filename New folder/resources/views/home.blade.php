                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h5 class="card-title mb-0" data-anchor="data-anchor">Top 3 Giver Of The Month - {{$monthname}}
                                    </h5>
                                </div>
                            </div>
                        </div>
                                                                    ...
                                                                    <div class="col-auto">
                                                                        <div class="avatar-sm p-1 py-2 h-auto bg-light rounded-3">
                                                                            <div class="text-center">
                                                                                <h5 class="mb-0">{{ Carbon\Carbon::createFromFormat('d.m.y H:i', $meeting->start_date)->format('d') }}</h5>
                                                                                <div class="text-muted">{{ Carbon\Carbon::createFromFormat('d.m.y H:i', $meeting->start_date)->format('D') }}</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col">
                                                                        <h5 class="text-muted mt-0 mb-1 fs-14">{{ Carbon\Carbon::createFromFormat('d.m.y H:i', $meeting->start_date)->format('d.m.y H:i') }} To {{ Carbon\Carbon::createFromFormat('d.m.y H:i', $meeting->End_date)->format('d.m.y H:i') }}</h5>
                                                                    <div class="d-flex justify-content-between">
                                                                    <a href="#" class="text-reset fs-15 mb-0">{{ $meeting->Meeting_title }}</a>
                                                                        ...
                                                                        <a href="{{ route('Membermeeting.Memberindex',$meeting->id)}}"
                                                                         class="btn btn-success btn-sm rounded-pill">{{ $meeting->member_count }} Members</a>
                                                                    </div>
                                                                    </div>
                                                                </div>
                                                            </li>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                ...
                                                <h4 class="fs-22 fw-bold ff-secondary text-white mb-8">
                                                     <span class="counter-value" data-target="{{ $pending }}">{{ $pending }}</span>/<span class="counter-value" data-target="{{ $totalpendingamount }}">{{ $totalpendingamount }}</span>
                                                </h4>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    ...
                                                    <span class="counter-value" data-target="{{ $approvecount }}">0</span>/<span class="counter-value" data-target="{{ $totalapproveamount }}">0</span>
                                                    </h4>
                                                    @if ($session->role_id == 1)
                    ...
                    data: [{
                        ...
                        dataPoints: [
                            @foreach($formatted_combined_data as $data)
                                { label: "{{ substr($data['month'], 0, 3) ?? "Unknown" }}-{{ substr($data['year'], -2) ?? "Unknown" }}", y: {{ $data['total_given'] ?? 0 }} },
                            @endforeach
                        ]
                    },
                    {
                        ...
                        dataPoints: [
                            @foreach($formatted_combined_data as $data)
                                { label: "{{ substr($data['month'], 0, 3) ?? "Unknown" }}-{{ substr($data['year'], -2) ?? "Unknown" }}", y: {{ $data['total_received'] ?? 0 }} },
                            @endforeach
                        ]
                    }]
                });
