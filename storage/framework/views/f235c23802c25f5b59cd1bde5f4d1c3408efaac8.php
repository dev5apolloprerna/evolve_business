<?php $__env->startSection('title', 'Reference List'); ?>
            ...
            <div class="container-fluid">          
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs nav-justified nav-border-top nav-border-top-success mb-3" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="<?php echo e(route('Admin-Reference.index')); ?>">
                                        <i class="fas fa-clock"></i> Pending
                                    </a>
                                </li>

                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="<?php echo e(route('Admin-Reference.Approve_list')); ?>" role="tab"
                                        aria-selected="false" tabindex="-1">
                                        <i class="fas fa-check-circle"></i> Approved
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="<?php echo e(route('Admin-Reference.Rejected_list')); ?>" role="tab"
                                        aria-selected="false" tabindex="-1">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" id="form" action="<?php echo e(route('Admin-Reference.index')); ?>">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h5 class="card-title mb-0" data-anchor="data-anchor">Connection Pending List
                                    </h5>
                                </div>
                                <div>
                                    <form action="<?php echo e(route('Admin-Reference.resendReminder')); ?>" method="POST" style="display:inline-block;" onsubmit="return confirm('Send reminder emails to all pending reference users?');">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" class="btn btn-success">Resend Reminder</button>
                                    </form>
                                    <a href="<?php echo e(route('Admin-Reference.storeview')); ?>"   class="btn btn-success">Add Connection</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane preview-tab-pane active" role="tabpanel"
                                    ...
                                    <div id="tableExample" data-list='{"valueNames":["name","email","age"]}'>
                                                ...
                                                <tbody class="list">
                                                    ...
                                                    <?php $__currentLoopData = $Business; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Business1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                           ...
                                                           <td class="text-center"><?php echo e($Business1->Reference_from); ?></td>
                                                            <td class="text-center"><?php echo e($Business1->Reference_to); ?></td>
                                                            ...
                                                            <td class="text-center"><?php echo e(\Carbon\Carbon::parse( $Business1->Reference_Date)->format('d-m-Y')); ?></td>
                                        ...
                                        <?php echo e($Business->appends(['fromdate' => $FromDate,'todate' => $ToDate,])->links()); ?>
            ...
            <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog " style="background-color: white;">
                    <div class="modal-content">
                        ...
                        <form method="post" action="<?php echo e(route('Admin-Reference.update')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="modal-body">
                                <input type="hidden" name="Reference_id" id="Reference_id" value="">
                                    <div class="md-3 mb-2">
                                        ...
                                        <select class="form-control" name="Reference_from" id="Editbusiness_from"
                                            required>
                                            <option value="" selected>Select Given By</option>
                                            <?php $__currentLoopData = $Data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($data->id); ?>"><?php echo e($data->first_name); ?>
                                    ...
                                    <div class="md-3 mb-2">
                                        ...
                                        <select class="form-control" name="Reference_to" id="Editbusiness_to" required>
                                            ...
                                            <?php $__currentLoopData = $Data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($data->id); ?>"><?php echo e($data->first_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <!-- new -->
                                    <div class="md-3 mb-2">
                                        ...
                                        <input class="form-control" id="EditReference_Name" name="Reference_Name" type="text"
                                            placeholder="Enter Reference Name" value="<?php echo e(old('Reference_Name')); ?>" required>
                                    </div>   
                                    <div class="md-3 mb-2">
                                    <label for="Company_Name"><span style="color:red;">*</span> Company Name</label>                                       
                                        <input type="Text" class="form-control" name="Company_Name"
                                            id="EditCompanyName" placeholder="Enter Company Name " required>
                                    </div>  
                                    <div class="md-3 mb-2">
                                    <label for="phonenumber"><span style="color:red;">*</span> Phone number</label>                                      
                                        <input type="phonenumber" class="form-control" name="phonenumber"
                                            id="Editphonenumber" placeholder="Enter phonenumber  " oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');" onKeyPress="if(this.value.length==10) return false;" maxlength="10" minlength="10" value="<?php echo e(old('phonenumber')); ?>"required>
                                    </div>      
                                    <div class="md-3 mb-2">
                                    ...
                                    <div class="md-3 mb-2">
                                    <label for="Refer_for_message"><span style="color:red;">*</span>Refer for message</label>                                      
                                        <input type="Text" class="form-control" name="Refer_for_message"
                                            id="Refer_for_message" placeholder="Enter Refer for message"maxlength="50" required>
                                    </div>                       
                                    <!-- new -->  
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form id="user-delete-form" method="POST" action="<?php echo e(route('Admin-Reference.delete')); ?>">
                            <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo e(route('Admin-Reference.status')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<script>
    ...
    <script>
        function getEditData(id) {
            // alert(id);
            var url = "<?php echo e(route('Admin-Reference.edit', ':id')); ?>";
    ...
    <script>
        function getEditDatastatus(id) {
            // alert(id);
            var url = "<?php echo e(route('Admin-Reference.statusget', ':id')); ?>";
            url = url.replace(":id", id);
            if (id) {
                $.ajax({
                    url: url,
...
// alert('hello');
        ...
        var strURL = "<?php echo e(route('Admin-Reference.exportReference')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/evolve_business_live/resources/views/Admin-Reference/index.blade.php ENDPATH**/ ?>