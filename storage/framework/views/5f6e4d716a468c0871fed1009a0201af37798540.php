...
<?php $__env->startSection('title', 'Membership plan List'); ?>
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    <form action="<?php echo e(route('membershipplans.store')); ?>" method="post"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="pt-3">
                                                    ...
                                                    <input type="text" class="form-control" name="plan_name"
                                                        ...
                                                        autocomplete="off" value="<?php echo e(old('plan_name')); ?>" required>
                                                </div>
                                                ...
                                                <div class="pt-3">
                                                    ...
                                                    <input type="number" class="form-control" name="duration_in_days"
                                                        id="duration_in_days" placeholder="Enter Duration in Days" value="<?php echo e(old('duration_in_days')); ?>" required>
                                                </div>

                                                <div class="pt-3">
                                                    <span style="color:red;">*</span> Amount
                                                    <input type="number" class="form-control" name="amount" id="amount"
                                                        placeholder="Enter Amount" value="<?php echo e(old('amount')); ?>" required>
                                                </div>

                                                <div class="pt-3">
                                                    <span style="color:red;">*</span> Discount%
                                                    <input type="number" class="form-control" name="discount"
                                                        id="discount" placeholder="Enter Discount" value="<?php echo e(old('discount')); ?>" required>
                                                </div>
                                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo e($data->duration_in_days); ?></td>
                                                <td class="text-center"><?php echo e($data->amount); ?></td>
                                                <td class="text-center"><?php echo e($data->discount); ?></td>
                                                <td class="text-center"><?php echo e($data->discountamout); ?></td>
                ...
                <div class="modal fade flip" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            action="<?php echo e(route('membershipplans.update')); ?>" autocomplete="off"
                            enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                    ...
                                    <form id="user-delete-form" method="POST"
                                        action="<?php echo e(route('membershipplans.delete')); ?>">
                                        <?php echo csrf_field(); ?>
...
<script>
    function getEditData(id) {
        var url = "<?php echo e(route('membershipplans.edit', ':id')); ?>";
    ...
    <script>
        function chkname() {
            ...
            var url = "<?php echo e(route('membershipplans.checkserviceprovider')); ?>";
            $.ajax({
                url: url,
                type: 'GET',
                data: {
    ...
    <script>
        function editchkname() {
            ...
            var url = "<?php echo e(route('membershipplans.editcheckserviceprovider')); ?>";
            $.ajax({
                url: url,
                type: 'GET',
                data: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp laravel11\htdocs\live_codes\Evolve Business\resources\views/membershipplans/index.blade.php ENDPATH**/ ?>