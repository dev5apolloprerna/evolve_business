            ...
            <div class="container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs nav-justified nav-border-top nav-border-top-success mb-3" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link " href="<?php echo e(route('Business.index')); ?>">
                                        <i class="fas fa-clock"></i> Pending
                                    </a>
                                </li>

                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="<?php echo e(route('Business.approve_list')); ?>" role="tab"
                                        aria-selected="false" tabindex="-1">
                                        <i class="fas fa-check-circle"></i> Approved
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="<?php echo e(route('Business.rejected_list')); ?>" role="tab"
                                        aria-selected="false" tabindex="-1">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" id="form" action="<?php echo e(route('Business.approve_list')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="row align-items-center">
                                     ...
                                     <div class="col-md-2 mb-2">
                                        ...
                                        <select class="form-control" name="business_type" id="business_type">
                                            ...
                                            <option value="1" <?php echo e($businesstype == '1' ? 'selected' : ''); ?>>Direct</option>
                                            <option value="2" <?php echo e($businesstype == '2' ? 'selected' : ''); ?>>Reference</option>
                                        </select>
                                        </div>
                                    </div>
                                    <!-- <div class="col-md-2 mb-2">
                                        <div class="d-flex align-items-center">                                
                                            <select class="form-select" id="given_by" name="given_by">
                                                    ...
                                                    <?php $__currentLoopData = $businesses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $businesses1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($businesses1->user_id); ?>" <?php echo e(isset($givenby) && $businesses1->user_id == $givenby ? 'selected' : ''); ?>><?php echo e($businesses1->Contact_person); ?></option>
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h5 class="card-title mb-0" data-anchor="data-anchor">Business Approved List
                                    </h5>
                                </div>
                                <div>
                                    <a href="<?php echo e(route('Business.storeview')); ?>"  class="btn btn-success">Add Business</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane preview-tab-pane active" role="tabpanel"
                                    ...
                                    <?php if($Count > 0): ?>    
                                                ...
                                                <tbody class="list">
                                                    ...
                                                    <?php $__currentLoopData = $Business; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Business1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <?php echo e($Business1->isapproved_status == 1 ? 'Approved' : ''); ?>
                                        ...
                                        <?php echo e($Business->appends(['business_type' => $businesstype,"given_by" => $givenby,'fromdate' => $FromDate,'todate' => $ToDate,])->links()); ?>
                                    ...
                                    <div class="md-3 mb-2">
                                        ...
                                        <select class="form-control" name="business_from" id="Editbusiness_from"
                                            ...
                                            <?php $__currentLoopData = $Data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($data->first_name); ?>"><?php echo e($data->first_name); ?> - (<?php echo e($data->mobile_number); ?>)
                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form id="user-delete-form" method="POST" action="<?php echo e(route('Business.deleteapprove')); ?>">
                            <?php echo csrf_field(); ?>
...
// alert('hello');
        ...
        var strURL = "<?php echo e(route('Business.exportapprove')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/evolve_business_live/resources/views/Business/approve_list.blade.php ENDPATH**/ ?>