                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    <form onsubmit="return validateSelections();" action="<?php echo e(route('Business.create')); ?>" method="post"
                                        enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="row gy-3 mb-3">
                                            <div class="col-lg-4 col-md-6"> Business Type               
                                              <span style="color:red;" class="error-message"><?php echo e($errors->first('business_type')); ?>*</span>
                                            ...
                                            <span style="color: red;">*</span>Given By                                              
                                                <span style="color:red;" class="error-message"><?php echo e($errors->first('business_from')); ?></span>
                                            ...
                                            <span style="color: red;">*</span>Given To                                              
                                                <span style="color:red;" class="error-message"><?php echo e($errors->first('business_to')); ?></span>
                                            ...
                                            <span style="color:red;" class="error-message"><?php echo e($errors->first('Business_amount')); ?></span>
                                            ...
                                            <span style="color:red;" class="error-message"><?php echo e($errors->first('business_Date')); ?></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/evolve_business_live/resources/views/Business/storeview.blade.php ENDPATH**/ ?>