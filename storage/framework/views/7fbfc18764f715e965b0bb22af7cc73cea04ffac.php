...
<?php $__env->startSection('title', 'Received List'); ?>
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h5 class="card-title mb-0" data-anchor="data-anchor">Business Received
                                    </h5>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="table-responsive scrollbar">
                                            <table class="table table-bordered table-striped fs--1 mb-0">
                                                ...
                                                <tr class="text-center">
                                                    <td style="text-align: end;" colspan="5">Total Approved</td>
                                                    <td><?php echo e($totalApprovedAmount); ?></td>
                                                </tr>
                                                <!-- <tr class="text-center">
                                                    <td style="text-align: end;" colspan="6">Total Rejected</td>
                                                    <td></td>
                                                </tr> -->
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12  col-xs-12 col-sm-12 padding-5 bottom-border-verydark">
                                                    <div class="alert alert-info clearfix profile-information padding-all-10 margin-all-0 backgroundDark">
                                                        <h1 class="font-white text-center"> Yet To Received Business </h1>
                                                    </div>
                                                </div>
                                            </div>                                           
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp laravel11\htdocs\live_codes\Evolve Business\resources\views/MemberBusiness/Received.blade.php ENDPATH**/ ?>