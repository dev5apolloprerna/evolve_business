        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <?php if($session->role_id == 1 || isset($permission['city']) && $permission['city'] == 1 || isset($permission['city_group']) && $permission['city_group'] == 1 || isset($permission['categories']) && $permission['categories'] == 1 || isset($permission['membershipplans']) && $permission['membershipplans'] == 1 || isset($permission['overteem']) && $permission['overteem'] == 1 || isset($permission['Banner']) && $permission['Banner'] == 1 || isset($permission['Utility']) && $permission['Utility'] == 1 || isset($permission['MasterEntry']) && $permission['MasterEntry'] == 1 || isset($permission['BannerImage']) && $permission['BannerImage'] == 1 || isset($permission['RegisterInquiry']) && $permission['RegisterInquiry'] == 1 || isset($permission['ContactInquiry']) && $permission['ContactInquiry'] == 1 || isset($permission['EventInquiry']) && $permission['EventInquiry'] == 1): ?>
                    ...
                    <?php if($session->role_id == 1 || $permission['MasterEntry'] == 1): ?>
                        ...
                        <div class="collapse menu-dropdown" id="sidebarApps">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('serviceprovider.index')); ?>" class="nav-link" data-key="t-chat">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('categories.index')); ?>" class="nav-link" data-key="t-chat">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('membershipplans.index')); ?>" class="nav-link" data-key="t-chat">
    ...
    <div class="collapse menu-dropdown" id="sidebarProduct">
        <ul class="nav nav-sm flex-column">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('Admin-Reference.index')); ?>" class="nav-link" data-key="t-chat">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarBusiness">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('MemberBusiness.index')); ?>" class="nav-link" data-key="t-chat">
                                <i class="fas fa-handshake"></i>Business Given
                            </a>
                            </li>
                           
                            <li class="nav-item">
                                <a href="<?php echo e(route('MemberBusiness.Received')); ?>" class="nav-link" data-key="t-chat">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown" id="sidebarConnection">
                                        <ul class="nav nav-sm flex-column">
                                            ...
                                            <li class="nav-item">
                                                <a href="<?php echo e(route('Reference.ReceivedReference')); ?>" class="nav-link" data-key="t-chat">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('reports.upcomingrenual')); ?>" class="nav-link" data-key="t-chat">
            ...
            <!-- member subscription expried date code start -->
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link" data-key="t-chat">
                       <b> <i class="fas fa-calendar-alt"></i> SUBSCRIPTION EXPIRIES ON :- <?php echo e(isset($subexpri['SubscriptionExpiredDate']) ? date('d-m-Y', strtotime($subexpri['SubscriptionExpiredDate'])) : ""); ?></b>
            ...
            <!-- member subscription expried date code end -->
                ...
                <!-- user utility end -->
                    <div class="collapse menu-dropdown" id="sidebarApps" style="max-height: 500px; overflow-y: auto; overflow-x: hidden;">
                        <ul class="nav nav-sm flex-column">
...
<?php /**PATH /var/www/html/evolve_business_live/resources/views/common/sidebar.blade.php ENDPATH**/ ?>