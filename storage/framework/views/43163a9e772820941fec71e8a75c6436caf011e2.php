            ...
            <div class="container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs nav-justified nav-border-top nav-border-top-success mb-3" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link " href="<?php echo e(route('Admin-Reference.index')); ?>">
                                        <i class="fas fa-clock"></i> Pending
                                    </a>
                                </li>

                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="<?php echo e(route('Admin-Reference.Approve_list')); ?>" role="tab"
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" id="form" action="<?php echo e(route('Admin-Reference.Approve_list')); ?>">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h5 class="card-title mb-0" data-anchor="data-anchor">Connection Approved List
                                    </h5>
                                </div>
                                <div>
                                                    ...
                                                    <?php $__currentLoopData = $Business; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Business1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <td class="text-center">
                                                           ...
                                                           <td class="text-center"><?php echo e($Business1->Reference_from); ?></td>
                                                            ...
                                                            <td class="text-center">
                                                                <?php echo e($Business1->isapproved_status == 1 ? 'Approve' : ''); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form id="user-delete-form" method="POST" action="<?php echo e(route('Admin-Reference.deleteapprove')); ?>">
                            <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php if(isset($Business1->isapproved_status)): ?>
                                ...
                                <select class="form-control" name="newStatus" id="newStatus"
                                    ...
                                    <option value="0" <?php echo e($Business1->isapproved_status == 0 ? 'selected' : ''); ?>>
                                        Pending</option>
...
// alert('hello');
        ...
        var strURL = "<?php echo e(route('Admin-Reference.exportapprove_ref')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/evolve_business_live/resources/views/Admin-Reference/Approve_list.blade.php ENDPATH**/ ?>