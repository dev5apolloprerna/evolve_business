<?php $__env->startSection('title', 'Member Products-Service Add'); ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    <form action="<?php echo e(route('MemberProducts.Store')); ?>" method="post"
                                        enctype="multipart/form-data">

                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name ="memberid" value="<?php echo e($id); ?>">
                                        ...
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-lg-4 col-md-6" id="fixed_price_input" style="display: none;">
                                                ...
                                                <input type="number" class="form-control" name="fixed_price"
                                                    id="fixed_price" placeholder="Enter price">
                                            </div>
                                                ...
                                                <div class="row gy-3">
                                                    <div class="col-md-6">
                                                        <input type="number" class="form-control" name="min_price"
                                                            id="min_price" placeholder="Min price">
                                                    </div>
                                                    <div class="col-md-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/evolve_business_live/resources/views/MemberProducts/ProductStoreview.blade.php ENDPATH**/ ?>