<?php $__env->startSection('title', 'Announcement Edit'); ?>
                            ...
                            <div class="card-body bg-light">
                                <div class="tab-content">
                                    <div class="tab-pane preview-tab-pane active" role="tabpanel"
                                        ...
                                        <form  method="post" action="<?php echo e(route('Announcement.update')); ?>"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mt-2">
                                                        ...
                                                        <input type="hidden" name="hiddenPhoto" class="form-control"
                                                            value="<?php echo e(old('photo') ? old('photo') : $Data->photo); ?>" id="hiddenPhoto">
                                                        <div id="viewimg">
                                                            <img src="<?php echo e(asset('Announcement') . '/' . $Data->photo); ?>" alt=""
                                                                height="70" width="70">
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/evolve_business_live/resources/views/Announcement/edit.blade.php ENDPATH**/ ?>