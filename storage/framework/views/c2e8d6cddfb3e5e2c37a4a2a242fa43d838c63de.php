            ...
            <div class="container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs nav-justified nav-border-top nav-border-top-success mb-3" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="<?php echo e(route('Business.index')); ?>">
                                        <i class="fas fa-clock"></i> Pending
                                    </a>
                                </li>

                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="<?php echo e(route('Business.approve_list')); ?>" role="tab"
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" id="form" action="<?php echo e(route('Business.index')); ?>">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h5 class="card-title mb-0" data-anchor="data-anchor">Business Pending List
                                    </h5>
                                </div>
                                <div>
                                    <a href="<?php echo e(route('Business.resendReminder')); ?>"class="btn btn-success">Resend
                                        Reminder</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/evolve_business_live/resources/views/Business/index.blade.php ENDPATH**/ ?>