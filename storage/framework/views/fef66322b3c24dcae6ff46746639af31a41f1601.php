<?php $__env->startSection('title', 'Award List'); ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="<?php echo e(route('Award.create', $id)); ?>" class="btn btn-success">Add Award
                                    </a>
                                </div>
                            </div>
                                        ...
                                        <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <?php else: ?>
                                                        <img src="<?php echo e(asset('Award/' . $data->photos)); ?>"
                                                            style="width:50px;height:50px;">
                                                    <?php endif; ?>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2 justify-content-center">
                                                        ...
                                                        <div class="d-flex gap-2">
                                                            ...
                                                            <a href="<?php echo e(route('Award.edit', $data->id)); ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form id="user-delete-form" method="POST" action="<?php echo e(route('Award.delete')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/evolve_business_live/resources/views/Award/index.blade.php ENDPATH**/ ?>