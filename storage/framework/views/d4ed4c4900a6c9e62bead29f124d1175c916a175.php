                        ...
                        <?php if ($meetingscount > 0): ?>
                            ...
                            <div class="card-body cust-over pt-0">
                                ...
                                <ul class="list-group list-group-flush border-dashed">
                                    ...
                                    <?php $__currentLoopData = $meetings;
                                    $__env->addLoop($__currentLoopData);
                                    foreach ($__currentLoopData as $meeting): $__env->incrementLoopIndices();
                        ...
                        <div class="card" style="height: 300px">
                            ...
                            <div class="card-body cust-over pt-0">
                                ...
                                <ul class="list-group list-group-flush border-dashed">
                                    ...
                                    <?php $__currentLoopData = $previousMeetings;
                                    $__env->addLoop($__currentLoopData);
                                    foreach ($__currentLoopData as $meeting): $__env->incrementLoopIndices();
                                        $loop = $__env->getLastLoop(); ?>
                                        <li class="list-group-item ps-0">
                                            ...
                                            <?php if ($topDirectcount > 0): ?>
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php $__currentLoopData = $topDirect;
                                                        $__env->addLoop($__currentLoopData);
                                                        foreach ($__currentLoopData as $index => $receiver): $__env->incrementLoopIndices();
                                                            $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                            ...
                                            <?php if ($topReferencecount > 0): ?>
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php $__currentLoopData = $topReference;
                                                        $__env->addLoop($__currentLoopData);
                                                        foreach ($__currentLoopData as $index => $Giver): $__env->incrementLoopIndices();
                                                            $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                            ...
                                            <?php if ($TopReferenceGivers > 0): ?>
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php $__currentLoopData = $Top_Reference_Givers;
                                                        $__env->addLoop($__currentLoopData);
                                                        foreach ($__currentLoopData as $index => $Giver): $__env->incrementLoopIndices();
                                                            $loop = $__env->getLastLoop(); ?>
                                                            <tr>
        ...
        var chart1 = new CanvasJS.Chart("chartContainer", {
            ...
            data: [{
                    ...
                    dataPoints: [
                        ...
                        <?php $__currentLoopData = $formatted_combined_data;
                        $__env->addLoop($__currentLoopData);
        ...
        var chart2 = new CanvasJS.Chart("TochartContainer", {
            ...
            data: [{
                    ...
                    dataPoints: [
                        ...
                        <?php $__currentLoopData = $to_formatted_combined_data;
                        $__env->addLoop($__currentLoopData);
                        foreach ($__currentLoopData as $data): $__env->incrementLoopIndices();
                            $loop = $__env->getLastLoop(); ?>
