        ...
        <div class="page-content">
            ...
            <script type="text/javascript" src="//js.nicedit.com/nicEdit-latest.js"></script>
                ...
                <div class="d-flex justify-content-end mb-3">
                    <a href="<?php echo e(route('Announcement.storeview')); ?>" class="btn btn-success">Add Announcement</a>
                </div>
                                                ...
                                                <tbody class="list">
                                                    ...
                                                    <?php $__currentLoopData = $Events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                 <img src="<?php echo e(asset('Announcement') . '/' . $Event->photo); ?>"
                                                                                style="width: 50px;height: 50px;">
                                                            </td>
                                                            <td class="text-center"><?php echo e($Event->description); ?></td>
                                                            <td class="d-flex gap-2 justify-content-center">
                                                            <a href="<?php echo e(route('Announcement.edit' ,$Event->id)); ?>"
                                                                    class="" title="Edit">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                    ...
                                    <form id="user-delete-form" method="POST"
                                        action="<?php echo e(route('Announcement.delete')); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/evolve_business_live/resources/views/Announcement/index.blade.php ENDPATH**/ ?>