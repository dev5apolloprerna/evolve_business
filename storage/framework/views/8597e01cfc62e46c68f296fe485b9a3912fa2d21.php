<?php $__env->startSection('title', 'City Group List'); ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    <form action="<?php echo e(route('serviceprovider.citygroupstore')); ?>" method="post"
                                                ...
                                                <div>
                                                    ...
                                                    <select class="form-control" name="city_id" required>
                                                        ...
                                                        <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($city->id); ?>"><?php echo e($city->city_name); ?>
                                        ...
                                        <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php echo e(optional($cities->firstWhere('id', $data->city_id))->city_name); ?>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" onsubmit="return EditvalidateFile()"
                                action="<?php echo e(route('serviceprovider.citygroupupdate')); ?>" autocomplete="off"
                                enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                        ...
                                        <form id="user-delete-form" method="POST"
                                            action="<?php echo e(route('serviceprovider.citygroupdelete')); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php $__env->startSection('scripts'); ?>
         ...
         <script>
             function getEditData(id) {
                 //alert(id);
                 var url = "<?php echo e(route('serviceprovider.citygroupedit', ':id')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/evolve_business_live/resources/views/serviceprovider/citygroupindex.blade.php ENDPATH**/ ?>